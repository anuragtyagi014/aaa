 ...
 * @package Promina
 */
$post_tags_on = promina_get_opt( 'post_tags_on', true );
$post_navigation_on = promina_get_opt( 'post_navigation_on', false );
$post_author_info_on = promina_get_opt( 'post_author_info_on', false );
$post_social_share_on = promina_get_opt( 'post_social_share_on', false );
$post_feature_image_on = promina_get_opt( 'post_feature_image_on', true );
$post_title_on = promina_get_opt('post_title_on', false);
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('single-hentry'); ?>>
    <?php if (has_post_format('gallery')) : ?>
        <div class="entry-featured">
            <?php
            $light_box = promina_get_post_format_value('post-gallery-lightbox', '0');
            $gallery_list = explode(',', promina_get_post_format_value('post-gallery-images', ''));
    ...
    <?php elseif (has_post_format('quote')) : ?>
        <div class="entry-featured">
            <?php
                $quote_text = promina_get_post_format_value('post-quote-cite', '');
    ...
    <?php elseif (has_post_format('link')) : ?>
        <div class="entry-featured">
            <?php
                $link_pf = promina_get_post_format_value('post-link-url', '#');
    ...
    <?php elseif (has_post_format('video')) : ?>
        <div class="entry-featured">
            <div class="entry-video featured-active">
                <?php
                $video_url = promina_get_post_format_value('post-video-url', '#');
                $video_file = promina_get_post_format_value('post-video-file', '');
                $video_html = promina_get_post_format_value('post-video-html', '');
                $video = '';
                if (!empty($video_url)) {
                    global $wp_embed;
    ...
    <?php elseif (has_post_format('audio')) : ?>
        <div class="entry-featured">
            <?php
                $audio_url = promina_get_post_format_value('post-audio-url', '#');
