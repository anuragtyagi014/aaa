...
$num_words = $widget->get_setting('num_words', 35);
...
$slidesToShow = !empty($slides_to_show)?$slides_to_show:2;
...
<?php if (is_array($posts)): ?>
    <div id="<?php echo esc_attr($html_id) ?>" class="cms-project-carousel layout1 cms-slick-slider">
                    ...
                    <div class="carousel-item-inner">
                        <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)): ?>
                            <div class="entry-featured">
                                <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>" target="_blank"><?php echo wp_kses_post($thumbnail); ?></a>
                            </div>
                        <?php endif; ?>
                        <div class="entry-body">
                            <div class="entry-body-inner">
                                ...
                                <<?php etc_print_html($title_tag);?> class="entry-title font-smooth">
                                    <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>" target="_blank"><?php echo esc_attr(get_the_title($post->ID)); ?></a>
                                ...
                                <div class="entry-content font-smooth">
                                    ...
                                    <div class="action-buttons">
                                        <a class="project-more" href="<?php echo esc_url(get_permalink($post->ID)); ?>"><i class="zmdi zmdi-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
