                   ...
                   <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false) && $settings['show_thumbnail'] == 'true'): ?>
                    ...
                    <div class="entry-body">
                        ...
                        <div class="entry-readmore">
                            <a class="btn-more" href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><span><?php echo esc_html__($settings['button_text'], 'promina'); ?></span><i class="fac fac-arrow-right space-left"></i></a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
