...
$load_more = array(
    ...
    'template_type' => 'project_grid_layout2',
);
?>

<div id="<?php echo esc_attr($html_id) ?>" class="cms-grid cms-project-grid2" data-layout="<?php echo esc_attr($layout_type); ?>" data-start-page="<?php echo esc_attr($paged); ?>" data-max-pages="<?php echo esc_attr($max); ?>" data-total="<?php echo esc_attr($total); ?>" data-perpage="<?php echo esc_attr($limit); ?>" data-next-link="<?php echo esc_attr($next_link); ?>">
        ...
        <div class="text-center">
            <div class="cms-load-more" data-loadmore="<?php echo esc_attr(json_encode($load_more)); ?>">
                <span class="btn-load-more">
                    <?php echo esc_html__('More Projects', 'promina') ?>
                    <i class="i-hidden"></i>
                </span>
            </div>
        </div>
