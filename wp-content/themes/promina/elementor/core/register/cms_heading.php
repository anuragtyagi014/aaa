...
etc_add_custom_widget(
    array(
        'name' => 'cms_heading',
        'title' => esc_html__('Heading', 'promina' ),
        'icon' => 'eicon-heading',
        ...
        'params' => array(
            'sections' => array(
                ...
                array(
                    'name' => 'title_section',
                    'label' => esc_html__('Custom Heading', 'promina' ),
                    'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
                    'controls' => array(
                        array(
                            'name' => 'heading_text',
                            'label' => esc_html__('Heading', 'promina' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Sub Heading', 'promina' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'placeholder' => esc_html__('Enter your sub title', 'promina' ),
                            'label_block' => true,
                        ),
                        array(
                            'name' => 'sub_type',
                            'label' => esc_html__('Sub Heading Type', 'promina'),
                        ...
                        array(
                            'name' => 'heading_size',
                            'label' => esc_html__('Heading HTML Tag', 'promina' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'h1' => 'H1',
                                'h2' => 'H2',
                ...
                array(
                    ...
                    'label' => esc_html__('Content Alignment', 'promina' ),
                ...
                array(
                    ...
                    'label' => esc_html__('Heading Style', 'promina' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'heading_color',
                            'label' => esc_html__('Heading Color', 'promina' ),
                ...
                array(
                    ...
                    'label' => esc_html__('Sub Heading Style', 'promina' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'subheading_color',
                            'label' => esc_html__('Sub Heading Color', 'promina' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                ...
                array(
                    ...
                    'label' => esc_html__('Description Style', 'promina' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Color', 'promina' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'default' => '',
                            'size_units' => [ 'px', '%' ],
                            'selectors' => [
