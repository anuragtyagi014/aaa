...
if(!function_exists('promina_register_custom_icon_library')){
    add_filter('elementor/icons_manager/native', 'promina_register_custom_icon_library');
    function promina_register_custom_icon_library($tabs){
        $custom_tabs = [
            'extra_icon1' => [
                'name' => 'material',
                'label' => esc_html__( 'Material Design Iconic', 'promina' ),
            ...
            'extra_icon2' => [
                'name' => 'flaticon',
                'label' => esc_html__( 'Flaticon', 'promina' ),
