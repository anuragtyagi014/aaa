...
function etc_stringify_attributes( $attributes ) {
    $atts = array();
...
if ( ! function_exists( 'etc_resize' ) ) {
     ...
     * @since 4.2
     */
    function etc_resize( $attach_id = null, $img_url = null, $width, $height, $crop = false ) {
...
if(!function_exists('etc_get_image_by_size')){
    function etc_get_image_by_size( $params = array() ) {
        ...
        if ( is_string( $thumb_size ) && ( ( ! empty( $_wp_additional_image_sizes[ $thumb_size ] ) && is_array( $_wp_additional_image_sizes[ $thumb_size ] ) ) || in_array( $thumb_size, $sizes, true ) ) ) {
            ...
            if ( is_array( $thumb_size ) ) {
                ...
                $p_img = etc_resize( $attach_id, null, $thumb_size[0], $thumb_size[1], true );
                ...
                if ( ! empty( $attachment ) ) {
                    ...
                    if ( $p_img ) {
                        ...
                        $attributes = etc_stringify_attributes( array(
                            'class' => $thumb_class,
                            'src' => $p_img['url'],
                            'width' => $p_img['width'],
                            'height' => $p_img['height'],
