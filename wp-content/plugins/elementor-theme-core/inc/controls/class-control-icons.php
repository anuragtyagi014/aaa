 ...
 * @since 1.0.0
 */
class Elementor_Theme_Core_Icons_Control extends \Elementor\Base_Data_Control {
    ...
    public function enqueue() {
        ...
        wp_register_script('cms_icons-control', ETC_URL . 'assets/lib/iconpicker/etc-iconpicker.js', array('jquery', 'jquery.fonticonpicker.js'), '1.0.0');
        wp_enqueue_script( 'cms_icons-control' );
    }
    ...
    public function content_template() {
        ...
        <div class="elementor-control-field">
            ...
            <div class="elementor-control-input-wrapper">
                ...
                <div class="etc-group">
                    <#
                        var template = '<div class="etc-group-item" style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; position: relative"><a class="etc-group-delete" href="#" style="position: absolute; z-index: 9; right: 10px; top: 8px;">&times;</a><div class="elementor-control elementor-label-block"><div class="elementor-control-content"><div class="elementor-control-field"><label class="elementor-control-title"><?php esc_html_e('Icon', ETC_TEXT_DOMAIN)?></label><div class="elementor-control-input-wrapper"><select class="elementor-control-tag-area etc-iconpicker">';
                        template += '<option value=""><?php esc_html_e('No Icons', ETC_TEXT_DOMAIN) ?></option>';
                        ...
                        template += '</select></div></div></div></div><div class="elementor-control elementor-label-block"><div class="elementor-control-content"><div class="elementor-control-field"><label class="elementor-control-title"><?php esc_html_e('Url', ETC_TEXT_DOMAIN)?></label><div class="elementor-control-input-wrapper"><input type="url" class="elementor-control-tag-area elementor-input etc-url-input" /></div></div></div></div></div>';
                    #>
                    <textarea class="etc-template" style="display: none;">{{{ template }}}</textarea>
                    <#
                    ...
                    #>
                            <div class="etc-group-item" style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; position: relative;">
                                <a class="etc-group-delete" href="#" style="position: absolute; z-index: 9; right: 10px; top: 8px;">&times;</a>
                                <div class="elementor-control elementor-label-block">
                                    <div class="elementor-control-content">
                                        <div class="elementor-control-field">
                                            <label class="elementor-control-title"><?php esc_html_e('Icon', ETC_TEXT_DOMAIN)?></label>
                                            <div class="elementor-control-input-wrapper">
                                                <select class="elementor-control-tag-area etc-iconpicker">
                                                    <#
                                                    var selected = ( '' === icon_val ) ? 'selected' : '';
                                                    #>
                                                    <option value="" {{ selected }}><?php esc_html_e('No Icons', ETC_TEXT_DOMAIN) ?></option>
                                                    <#
                                                    _.each( data.options, function( icons, group ) {
                                                    #>
                                ...
                                <div class="elementor-control elementor-label-block">
                                    <div class="elementor-control-content">
                                        <div class="elementor-control-field">
                                            <label class="elementor-control-title"><?php esc_html_e('Url', ETC_TEXT_DOMAIN)?></label>
                                            <div class="elementor-control-input-wrapper">
                                                <input type="url" class="elementor-control-tag-area elementor-input etc-url-input" value="{{ url_val }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="etc-group-actions" style="text-align: center;">
                    <button class="elementor-button elementor-button-default etc-group-add" type="button">
