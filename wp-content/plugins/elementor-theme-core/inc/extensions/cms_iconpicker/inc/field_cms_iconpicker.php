...
if (!class_exists('ReduxFramework_cms_iconpicker')) {
    class ReduxFramework_cms_iconpicker {
        function __construct($field = array(), $value = '', $parent) {
            $this->parent = $parent;
            $this->field = $field;
            $this->value = $value;

            $this->extension_url = cms_redux_extensions()->extensions_url . 'cms_iconpicker/';
        }
        ...
        function render() {
            ...
            ?>
                <select name="<?php echo $this->field['name'] . $this->field['name_suffix']; ?>" class="cms-iconpicker">
                    <option value=""><?php esc_html_e('No Icons', ETC_TEXT_DOMAIN) ?></option>
                    <?php
        ...
        public function enqueue() {
            ...
            if (!wp_script_is('jquery.fonticonpicker.js')) {
                wp_enqueue_script('jquery.fonticonpicker.js', ETC_URL . 'assets/lib/iconpicker/jquery.fonticonpicker.js', array('jquery'), 'all', true);
            }
            if (!wp_script_is('cms-iconpicker-js')) {
                wp_enqueue_script(
                    'cms-iconpicker-js',
                    $this->extension_url . 'inc/field_cms_iconpicker.js',
        ...
        public function get_icons(){
            ...
            $icons = apply_filters("redux_cms_iconpicker_field/get_icons", $icons);
