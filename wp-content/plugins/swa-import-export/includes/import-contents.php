...
function swa_ie_content_import($options)
{
    ...
    $attachment = empty($options['attachment']) ? swa_ie_add_placeholder_image() : null;
...
function swa_ie_add_placeholder_image(){
 ...
 * @param $attachment
 */
function swa_ie_replace_content($content, $attachment){

    $_replaces = apply_filters('swa_ie_replace_content', array(), $attachment);
